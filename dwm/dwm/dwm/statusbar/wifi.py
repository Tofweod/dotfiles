...
def notify(string=""):
    ...
    match int(connect_status_):
        ...
        case -1:
            os.system(
                "notify-send 'Wifi no connected' 'Press right buttom to open wifi connect tool.(nmtui)' -r 1024"
            )
            pass
        case _:
            os.system(
                "notify-send 'The wifi device is disable, please cheack your wifi device' 'Press right buttom to open wifi connect tool.(nmtui)' -r 1024"
            )
            pass
