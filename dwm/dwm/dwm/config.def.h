...
static const unsigned int systrayspadding = 3;         /* 托盘和状态栏的间隙 */
static const unsigned int borderpx        = 4;         /* 窗口边框大小 */
static int gappi                          = 2;        /* 窗口与窗口 缝隙大小 */
static int gappo                          = 0;        /* 窗口与边缘 缝隙大小 */
static const int _gappo                   = 2;        /* 窗口与窗口 缝隙大小 不可变 用于恢复时的默认值 */
static const int _gappi                   = 1;        /* 窗口与边缘 缝隙大小 不可变 用于恢复时的默认值 */
...
static const Layout layouts[] = {
	...
	{ "󰜩",      flextile,         { -1, -1, SPLIT_HORIZONTAL, LEFT_TO_RIGHT, TOP_TO_BOTTOM, 0, NULL } }, // bstackhoriz
...
//=============================================================================
    ...
    { MODKEY,              XK_u,        spawn,   SHCMD("dmenu_run") }, // dmenu_run
...
//=============================================================================
    ...
    TAGKEYS(XK_8, 7,  0)
    TAGKEYS(XK_9, 8,  0)
    TAGKEYS(XK_c, 6,  "/bin/zsh -c 'brave'") 
    TAGKEYS(XK_m, 7,  "/usr/bin/yesplaymusic")
...
//=============================================================================
{ 0, XF86XK_AudioMute,         spawn, SHCMD("pamixer -t;  python3 /home/tofweod/dwm/dwm/statusbar/vol.py notify ") },
{ 0, XF86XK_AudioRaiseVolume,  spawn, SHCMD("pamixer -i 5;python3 /home/tofweod/dwm/dwm/statusbar/vol.py notify ") },
{ 0, XF86XK_AudioLowerVolume,  spawn, SHCMD("pamixer -d 5;python3 /home/tofweod/dwm/dwm/statusbar/vol.py notify ") },
